...
export default function WelcomePage() {
  ...
  // It gives the how mush screen is scrolled in pixels.

  const yCity = useTransform(scrollY, [0, 200], [0, -100]);
  // first [] is to check the value of scrollY, according to that value will be picked from second [].
  // Ex if scrollY is 200, yCity will be -100. If it is 100 then yCity will be -50 etc.
  // len of first [] == len of second []
  const opacityCity = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.5, 0]);
  const yHero = useTransform(scrollY, [0, 200], [0, -350]);
