...
// On next renders, React will give you the same function again if the dependencies have not changed since the last render. Otherwise, it will give you the function that you have passed during the current render, and store it in case it can be reused later. 
...
// How to cache a function between re-renderes of component,

// 1. Wrap functions definition into the useCallback Hook.
